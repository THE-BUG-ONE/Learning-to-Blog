...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    public PageResult<CommentResp> getCommentList(CommentBackReq commentBackReq) {
        Integer limit = commentBackReq.getLimit();
        Integer page = commentBackReq.getPage();
        ...
        //获取筛选后的评论列表
        List<Comment> commentList = page(new Page<>(page, limit),
                        lambdaQuery()
        ...
        List<CommentResp> commentRespList = BeanCopyUtils.copyBeanList(commentList, CommentResp.class)
                ...
                .peek(commentResp ->{
                    ...
                    commentResp
                            ...
                            .setLikeCount(Long.valueOf(Optional.ofNullable(
