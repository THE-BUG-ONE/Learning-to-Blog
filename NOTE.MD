...
- There is no getter for property named 'param' in 'class com.framework.entity.vo.request.ArticleConditionReq'
...
- 前端请求参数类型query与body
> Query查询参数，将参数拼在请求地址上
  Body请求体参数，请求体中的数据，可以传递对象 (一般json都是body传参）
